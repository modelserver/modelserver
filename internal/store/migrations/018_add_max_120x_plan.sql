-- 018_add_max_120x_plan.sql
--
-- Introduce a Max 120x tier sitting above Max 80x. Credit budgets scale
-- linearly from Max 40x (×3) so the 5h / 7d proportions stay identical.
-- Model credit rates are shared across all tiered plans and copied
-- verbatim from 013_add_max_80x_plan.sql.
...
VALUES
    ('Max 120x', 'max_120x', 'Max 120x', 'Same usage limits as Claude Max (120x)', 12000, 599999, 1,
     '[{"window":"5h","window_type":"sliding","max_credits":66000000,"scope":"project"},{"window":"7d","window_type":"sliding","max_credits":499999800,"scope":"project"}]',
     '{
